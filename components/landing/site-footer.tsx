      ...
      <div className="reveal-item mx-auto max-w-[1440px] px-5 sm:px-8">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xs">Handcrafted log homes since 1995.<br/> Україна та Європа.</p>
        ...
        <p className="mt-12 text-xs text-[#8B7355]/70">© {new Date().getFullYear()} Lavanda. Усі права захищені.</p>
      </div>
    </footer>
  );
}
