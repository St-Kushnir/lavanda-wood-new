      ...
      <div className="mx-auto grid max-w-[1440px] gap-12 px-5 sm:px-8 lg:grid-cols-2 lg:items-center lg:gap-16">
        <div className="reveal-item">
          ...
          <p className=" mt-6 sm:mt-8 lg:mt-14 font-sans text-base leading-8 text-[#EAE7E1]/75">
            ...
            Будівництво виконується з цільної круглої деревини діаметром 30–50 см. Використовується дерево віком від 80 років і більше
            із максимально щільним зовнішнім шаром (заболонню), що забезпечує виняткову міцність, стабільність і
